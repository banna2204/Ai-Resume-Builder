  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input type="text" placeholder='Enter a skill (e.g., JavaScript,Project Manament' className='flex-1 px-3 py-2 text-sm' onChange={(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}/>
      ...
      {data.length > 0 ? (
        <div className='flex flex-wrap gap-2'>
          ...
          <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relavent skills. Include both technical and soft skills.</p>
          </div>
    </div>
  )
}
