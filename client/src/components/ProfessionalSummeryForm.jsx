    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <textarea
          ...
          placeholder="Write a proffessional summery that highlights your key strengths and career objectives... "
        />
        <p className="text-xs text-gray-500 max-w-4/5 mx-auto text-center ">
          Tip: Keep it concise (3-4 sentences) and focus on your most relavant
