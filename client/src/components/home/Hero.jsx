    ...
    <div className="min-h-screen pb-20">
      ...
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="flex gap-2">
              ...
              <Link to='/app?state=login' className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-slat-50 transition-all rounded-full text-slate-700 hover:text-slate-900" hidden={user}>
                  Login
              </Link>
              <Link to='/app' className="hidden md:block px-6 py-2 border active:scale-95 bg-green-500 hover:bg-green-600 transition-all rounded-full text-white ring hover:ring-blue-500" hidden={!user}>
                  Dashboard
              </Link>
          </div>
