    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <PlusIcon className="size-11 transition-all durartion-300 p-2.5 bg-gradient-to-br from-indigo-300 to-indigo-500 text-white rounded-full" />
          ...
          >
            <UploadCloudIcon className="size-11 transition-all durartion-300 p-2.5 bg-gradient-to-br from-purple-300 to-purple-500 text-white rounded-full" />
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                style={{
                  background: `linear -gradient(135deg, ${baseColor}10, ${baseColor}14)`,
